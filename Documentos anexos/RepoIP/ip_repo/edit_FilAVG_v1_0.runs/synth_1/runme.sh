...
HD_PWD='/home/pablo/Documentos/RepoIP/ip_repo/edit_FilAVG_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FilAVG_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FilAVG_v1_0.tcl
